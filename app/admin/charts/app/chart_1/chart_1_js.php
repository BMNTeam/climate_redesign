    ...
    function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            ['<?php echo( $months[$i] ); // Print month name
                ...
                echo("createCustomTooltip('$area', '$years', $precipitations)");
                ...
                $residues_different = $arr2[$i]-$arr1[$i];
                $area  = $second_region['region_name'];
                $years = $second_region['years'];
                echo("createCustomTooltip('$area', '$years', $residues_different)");
                ?>, <?php
        ...
        function createCustomTooltip (area, years, differents) {

            return  '<div style="padding:10px;">'+
                '<h5>'+ area + ': ' + '<span>'+years+'</span></h5>'+
            '<p style="font-size: 1.25rem;"> Осадки: <i>'+differents+'мм.</i> </p>'+
            '</div>'
        }
